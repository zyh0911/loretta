...
PATH=${PATH:-sst2}
TASK=${TASK:-sst2}
current_pathd="/hpc/home/connect.yzuo099/loretta/bert_model/output/"
...
python run_glue_v6.py \
  ...
  --num_train_epochs=$EPOCH --per_device_train_batch_size=$BS --output_dir="$current_pathd" --max_seq_length=128 \
